...
class ViewControllerWishedComment: UIViewController,UITableViewDelegate,UITableViewDataSource,UITabBarDelegate  {
   ...
   func tabBar(_ tabBar: UITabBar, didSelect item: UITabBarItem) {
    ...
    @IBAction func clickNewTest(_ sender: Any) {
         ...
         ProgressHUD.showSuccess("Send Successfully")
