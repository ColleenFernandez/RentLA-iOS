...
class ViewControllerReceivedMessages: UIViewController,UITableViewDelegate,UITableViewDataSource,UITabBarDelegate,customProtocol  {
    ...
    override func viewDidLoad() {
        ...
        let nib = UINib(nibName: "CommentCell1", bundle: nil)
        tblView.register(nib, forCellReuseIdentifier: "CommentCell1")
    ...
    func numberOfSections(in tableView: UITableView) -> Int
            ...
            func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int
            {
               ...
               func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
               {
                   ...
                   let cell:CommentCell1 = self.tblView.dequeueReusableCell(withIdentifier: "CommentCell1") as! CommentCell1
               ...
               // cell.btnHeart.addTarget(self, action: #selector(self.delClicked(_:)), for: .touchUpInside)
                                     //    cell.btnHeart.tag = (indexPath.section * 1000) + indexPath.row
