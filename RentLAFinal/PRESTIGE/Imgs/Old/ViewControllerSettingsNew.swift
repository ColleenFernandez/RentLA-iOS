...
class ViewControllerSettingsNew: UIViewController,UITableViewDelegate,UITableViewDataSource,UITabBarDelegate,customProtocol  {
   ...
   func tabBar(_ tabBar: UITabBar, didSelect item: UITabBarItem) {
    ...
    @IBAction func clickNewqProfile(_ sender: Any) {
    ...
    @IBAction func clickTerms(_ sender: Any) {
        ...
        UserDefaults.standard.set("Terms & Conditions", forKey: "GET_TITLE")
    ...
    @IBAction func clickPrivacy(_ sender: Any) {
        ...
        UserDefaults.standard.set("Privacy Policy", forKey: "GET_TITLE")
        if let viewController = UIStoryboard(name: "\(UserDefaults.standard.string(forKey: "STORY_BOARD")!)", bundle: nil).instantiateViewController(withIdentifier: "ViewControllerOthers") as? ViewControllerOthers
               {
                   if let navigator = navigationController
                   {
    ...
    @IBAction func clickAbout(_ sender: Any) {
        UserDefaults.standard.set("About Us", forKey: "GET_TITLE")
        if let viewController = UIStoryboard(name: "\(UserDefaults.standard.string(forKey: "STORY_BOARD")!)", bundle: nil).instantiateViewController(withIdentifier: "ViewControllerOthers") as? ViewControllerOthers
               {
                   if let navigator = navigationController
                   {
   ...
   func didTapSomeButton(_ getController: String?) {
    ...
    @IBAction func clickSave(_ sender: Any) {
         ...
         let alert = UIAlertController(title: "efNef", message: "Do you want to logout?", preferredStyle: .alert)
