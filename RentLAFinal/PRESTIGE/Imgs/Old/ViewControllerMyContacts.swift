...
class ViewControllerMyContacts: UIViewController,UITableViewDelegate,UITableViewDataSource,UITabBarDelegate,customProtocol  {
    ...
    override func viewDidLoad() {
        ...
        tblView.register(nib, forCellReuseIdentifier: "ContactCell")
