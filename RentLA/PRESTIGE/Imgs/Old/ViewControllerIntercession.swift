...
class ViewControllerIntercession: UIViewController,UITableViewDelegate,UITableViewDataSource,UITabBarDelegate,customProtocol  {
   ...
   func tabBar(_ tabBar: UITabBar, didSelect item: UITabBarItem) {
    ...
    @IBAction func clickTerms(_ sender: Any) {
        ...
        UserDefaults.standard.set("Prayer", forKey: "GET_TITLE")
    ...
    @IBAction func clickPrivacy(_ sender: Any) {
         ...
         UserDefaults.standard.set("Workshop", forKey: "GET_TITLE")
    ...
    @IBAction func clickAbout(_ sender: Any) {
         UserDefaults.standard.set("Thanks Giving", forKey: "GET_TITLE")
