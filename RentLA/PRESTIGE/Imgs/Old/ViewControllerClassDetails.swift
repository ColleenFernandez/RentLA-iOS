...
class ViewControllerClassDetails: UIViewController,UITableViewDelegate,UITableViewDataSource,UITabBarDelegate,customProtocol  {
    ...
    override func viewDidLoad() {
        ...
        self.lblThanks.text = "\(UserDefaults.standard.string(forKey: "GET_TITLE")!)"
   ...
   func tabBar(_ tabBar: UITabBar, didSelect item: UITabBarItem) {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == 4 || indexPath.row == 8  || indexPath.row == 15
         {
             //cell.imgLike.image = UIImage.init(named: "message.png")
             UserDefaults.standard.set("Gods Gift", forKey: "GET_TITLE_C")
         }
         else if indexPath.row == 1 || indexPath.row == 5  || indexPath.row == 10
         {
              //cell.imgLike.image = UIImage.init(named: "call.png")
              UserDefaults.standard.set("Jesus Answers Prayer", forKey: "GET_TITLE_C")
         }
         else if indexPath.row == 2 || indexPath.row == 6  || indexPath.row == 11
         {
             UserDefaults.standard.set("Dacis & Jonathan", forKey: "GET_TITLE_C")
              //cell.imgLike.image = UIImage.init(named: "call1.png")
         }
         else if indexPath.row == 3 || indexPath.row == 7  || indexPath.row == 12
         {
             UserDefaults.standard.set("Faith", forKey: "GET_TITLE_C")
                 // cell.imgLike.image = UIImage.init(named: "call2.png")
        }
