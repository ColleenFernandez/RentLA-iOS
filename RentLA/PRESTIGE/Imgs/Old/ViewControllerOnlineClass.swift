...
class ViewControllerOnlineClass: UIViewController,UITableViewDelegate,UITableViewDataSource,UITabBarDelegate  {
    ...
    override func viewDidLoad() {
        ...
        //self.lblget.text = "\(UserDefaults.standard.string(forKey: "GET_TITLE_C")!)"
