...
class ViewControllerMyuPost: UIViewController,UITableViewDelegate,UITableViewDataSource,UITabBarDelegate,customProtocol  {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
           ...
           if let viewController = UIStoryboard(name: "\(UserDefaults.standard.string(forKey: "STORY_BOARD")!)", bundle: nil).instantiateViewController(withIdentifier: "ViewControllerEventDetails") as? ViewControllerEventDetails
                                                 {
                                                     if let navigator = navigationController
                                                     {
                                                         navigator.pushViewController(viewController, animated: true)
            ...
            func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int
            {
               ...
               func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
               {
                ...
                if indexPath.row % 2 == 0 {
                    ...
                    cell.imageObj.image = UIImage.init(named: "ann.jpeg")
                  
                } else {
                 
                    cell.imageObj.image = UIImage.init(named: "ann1.jpg")
