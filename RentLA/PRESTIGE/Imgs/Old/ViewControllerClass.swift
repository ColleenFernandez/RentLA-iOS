...
class ViewControllerClass: UIViewController,UITableViewDelegate,UITableViewDataSource,UITabBarDelegate,customProtocol  {
   ...
   func tabBar(_ tabBar: UITabBar, didSelect item: UITabBarItem) {
    ...
    @IBAction func clickTerms(_ sender: Any) {
        ...
        if let viewController = UIStoryboard(name: "\(UserDefaults.standard.string(forKey: "STORY_BOARD")!)", bundle: nil).instantiateViewController(withIdentifier: "ViewControllerClassDetails") as? ViewControllerClassDetails
                      {
                          if let navigator = navigationController
                          {
                              navigator.pushViewController(viewController, animated: true)
