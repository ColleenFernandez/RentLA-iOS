...
class ViewControllerNewProfile: UIViewController,UITableViewDelegate,UITableViewDataSource,UITabBarDelegate,customProtocol  {
   ...
   @IBAction func clickBack(_ sender: Any) {
    ...
    @IBAction func addCelebrations(_ sender: Any) {
