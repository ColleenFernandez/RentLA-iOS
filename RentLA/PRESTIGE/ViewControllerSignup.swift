...
class ViewControllerSignup: UIViewController {
    ...
    @IBAction func clickTerms(_ sender: Any) {
        openWebBrowser(url: "https://rentla.net/terms-of-us-p39")
    }
    
    @IBAction func clickPrivacy(_ sender: Any) {
        openWebBrowser(url: "https://rentla.net/privacy-policy-p37")
    }
    
    @IBAction func clickContact(_ sender: Any) {
        openWebBrowser(url: "https://rentla.net/contact-us-p23")
    }
